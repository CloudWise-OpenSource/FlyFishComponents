...
export default class ImageComponent extends Component {
  ...
  _draw() {
    console.warn('draw', this.getData(), this.data, this);
  }
   ...
   */
  _render() {
    console.warn(this.getData(), this.data, this);
    const {
      image,
      type,
      animationSwitch,
    ...
    let pureClassname = this.getContainer()
      .attr('class')
      .replace(/scale|breath|rotate/gi, '');
    let classname = this.getContainer()
      .attr('class')
      .replace(/scale|breath|rotate/gi, '');
    ...
    if (animationSwitch) {
      style = {
        ...
        animationIterationCount:
          animationIterationCount === -1 ? 'infinite' : animationIterationCount,
      };
