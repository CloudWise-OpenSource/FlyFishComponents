...
/******/ 	return __webpack_require__(__webpack_require__.s = "./template/main.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*!*******************************************************************************************!*\
  !*** /Users/caryzhou/Documents/FlyFish2.0/component-bundle/node_modules/lodash/lodash.js ***!
  \*******************************************************************************************/
...
/* harmony import */ var _NavigationOne__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./NavigationOne */ "./src/NavigationOne.js");
...
var Component = function (_ReactComponent) {
	...
	_createClass(Component, [{
		...
		value: function getReactComponent() {
			return _NavigationOne__WEBPACK_IMPORTED_MODULE_2__["default"];
		}
	}]);
...
/* harmony import */ var less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! less */ "./node_modules/less/dist/less.js");
/* harmony import */ var less__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(less__WEBPACK_IMPORTED_MODULE_2__);
...
var NavigationOne = function (_Component) {
  _inherits(NavigationOne, _Component);

  function NavigationOne(props) {
    _classCallCheck(this, NavigationOne);

    var _this = _possibleConstructorReturn(this, (NavigationOne.__proto__ || Object.getPrototypeOf(NavigationOne)).call(this, props));

    _this.id = ('uniq-id-' + Math.random(Math.random() * 10) + '-' + Date.now()).replace('0.', '');
    ...
    _this.translation = function () {
      ...
      var content = text;(arrAy || []).forEach(function (item) {
  ...
  _createClass(NavigationOne, [{
    key: 'UNSAFE_componentWillReceiveProps',
    value: function UNSAFE_componentWillReceiveProps(nextProps) {
      var _nextProps$style = nextProps.style,
          style = _nextProps$style === undefined ? '' : _nextProps$style,
          _nextProps$parent = nextProps.parent,
          $container = _nextProps$parent.$container,
          $wrap = _nextProps$parent.$wrap;

      var customStyle = $wrap.find('style[data-id="custom-style"]');
      $container.attr('id', this.id);
      less__WEBPACK_IMPORTED_MODULE_2___default.a.render('#' + this.id + ' { ' + style + ' }', function (error) {
        ...
        if (!error) {
          if (customStyle.length) {
            ...
            $('<style data-id="custom-style">' + css + '</style>').insertBefore($container);
          }
        }
      });
    }
    ...
    value: function render() {
      var _props = this.props,
          ...
          backgroundTop = _props.backgroundTop,
          style = _objectWithoutProperties(_props, ['text', 'backgroundTop']);
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
        'div',
        { className: 'ff-component-wrap one', style: backgroundStyle },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('div', { className: 'ff-component-navigation', style: style, dangerouslySetInnerHTML: { __html: content } })
      );
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (NavigationOne);
...
Object(data_vi_components__WEBPACK_IMPORTED_MODULE_0__["registerComponent"])('61aa27acd39bdf74f6d602d7', 'v-current', _src_Component__WEBPACK_IMPORTED_MODULE_1__["default"]);
