...
export default class ChartComponent extends ReactComponent {
  ...
  getDefaultData() {
    return [
      ...
      { id: 1, name: '山东省', value: 300, link: 3 },
...
// 大部分还算是比较符合, 有几个需要改一下:
const fakeGeoInfo = [
  { name: '台湾省', center: [122.329062, 25.544332] },
  { name: '黑龙江省', center: [124.242464, 45.556967] },
  
  { name: '北京市', center: [115.805285, 39.204989] },
  // { name: '天津市', center: [117.890182, 38.725596] },
  { name: '吉林省', center: [123.3245, 43.486841]},
  { name: '西藏自治区', center: [91.132212, 30.660361] },
  // { name: '福建省', center: [120.806239, 27.375302] },
  { name: '辽宁省', center: [121.429096, 41.396767] },
  // { name: '江苏省', center: [121.767413, 32.941544] },
  // { name: '江西省', center: [118.092151, 28.676493] },
  { name: '内蒙古自治区', center: [111.670801, 40.418311] },
  // { name: '重庆市', center: [108.504962, 29.933155] },
  // { name: '青海省', center: [97.378916, 34.923178] },
  { name: '宁夏回族自治区', center: [106.778179, 38.06637] },
  { name: '河南省', center: [113.665412, 33.857975] },
  { name: '新疆维吾尔自治区', center: [89.617733, 43.792818] },
