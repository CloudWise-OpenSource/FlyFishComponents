        ...
        <Form>
          ...
          >
            ...
            <FormItem label="水平对齐">
              <div style={{ width: '115px' }}>
                <Radio.Group
                  onChange={(event) =>
                    this.updateOptions({ justifyContent: event.target.value })
                  }
            ...
            <FormItem label="垂直对齐">
              <div style={{ width: '115px' }}>
                <Radio.Group
                  onChange={(event) =>
                    this.updateOptions({ alignItems: event.target.value })
                  }
          ...
          <FormItem label="是否开启链接跳转">
            <div style={{ width: '115px' }}>
              <Radio.Group
                onChange={(event) =>
                  this.updateOptions({ isLink: event.target.value })
                }
          ...
          <FormItem label="超链接打开窗口方式">
            <Radio.Group
              onChange={(event) =>
                this.updateOptions({ isNewWindow: event.target.value })
              }
