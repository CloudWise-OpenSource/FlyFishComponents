...
var Title = function (_Component) {
	...
	function Title(props) {
		...
		_this.handleTitleClick = function () {
			...
			if (isLink && hrefUrl && hrefUrl.length) isNewWindow ? window.open(hrefUrl) : window.location.href = hrefUrl;
		};
		...
		_this.translation = function () {
			...
			(arrAy || []).forEach(function (item) {
				...
				var replaceData = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.get(data, regularValue);
				var newdata = typeof replaceData === 'undefined' ? '' : replaceData;
	...
	_createClass(Title, [{
		...
		value: function UNSAFE_componentWillReceiveProps(nextProps) {
			...
			less__WEBPACK_IMPORTED_MODULE_2___default.a.render('#' + this.id + ' { ' + style + ' }', function (error) {
				...
				console.log(_this2.id, css, error);
				if (!error) {
		...
		value: function render() {
			...
			return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
				'div',
				{ className: 'ff-component-title', style: style },
...
Object(data_vi_components__WEBPACK_IMPORTED_MODULE_0__["registerComponent"])('61aa27abd39bdf74f6d600f0', 'v-current', _Component__WEBPACK_IMPORTED_MODULE_1__["default"]);
